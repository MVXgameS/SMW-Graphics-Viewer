...
//Presets
const gfxPresets = [
  { name: "GFX00", path: "Graphics\GFX00.bin" },
  { name: "GFX01", path: "Graphics\GFX01.bin" },
];

const palettePresets = [
  { name: "Palette00", path: "Palettes\Palette00.pal" },
  { name: "Palette01", path: "Palettes\Palette00.pal" },
];
